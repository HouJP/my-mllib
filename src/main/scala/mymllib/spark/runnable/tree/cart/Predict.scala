package mymllib.spark.runnable.tree.cart
...
object Predict {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("RunSparkCARTPredict") {
      head("RunSparkCART: an example app for CART.")
