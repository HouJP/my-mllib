...
/**
  * Class of aggregator to statistic status of labels for computing of Gini impurity.
  *
...
private[cart] class GiniAggregator(off_fs: Array[Int],
  ...
  /**
    * Method to calculate Gini impurity, prediction and labels count for left child.
    *
    * @param id_f ID of the feature specified, indexed from 0
    * @param id_s ID of the [[mymllib.spark.model.tree.cart.CARTSplit]] specified, indexed from 0
