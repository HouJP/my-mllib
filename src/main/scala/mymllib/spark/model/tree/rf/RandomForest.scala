package mymllib.spark.model.tree.rf
...
object RandomForest extends Logging {
  ...
  /**
    ...
    * @return a [[mymllib.spark.model.tree.rf.RandomForestModel]] instance
    */
...
private[tree] class RandomForest(impurity: String,
  ...
  /**
    ...
    * epresented as an RDD of [[mymllib.common.obj.LabeledPoint]].
    *
    * @param train_data Training data points.
    * @return a [[mymllib.spark.model.tree.rf.RandomForestModel]] instance which can be used to predict.
    */
