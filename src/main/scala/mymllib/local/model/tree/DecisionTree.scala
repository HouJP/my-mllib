...
object DecisionTree {
  ...
  /**
    ...
    * @return a [[mymllib.local.model.tree.DecisionTreeModel]] instance.
    */
...
private[tree] class DecisionTreeTrainer(impurity: Impurity,
  ...
  /**
    ...
    *
    * @param train_data Training data which represented as a Sequence of [[mymllib.common.obj.LabeledPoint]].
    * @param valid_data Validation data which represented as a Sequence of [[mymllib.common.obj.LabeledPoint]] and can be none.
    * @return A [[mymllib.local.model.tree.DecisionTreeModel]] instance.
    */
  def train(train_data: Seq[LabeledPoint],
  ...
  /**
    ...
    * @return Array of [[mymllib.local.model.tree.DecisionTreeNode]].
    */
  ...
  /**
    ...
    *
    * @param input        Training data which represented as a RDD [[mymllib.common.obj.LabeledPoint]].
    ...
    * @return A tuple of [[mymllib.local.model.tree.DecisionTreeSplit]] and [[mymllib.local.model.tree.DecisionTreeBin]].
    */
  ...
  /**
    ...
    *
    * @param agg_leaves Aggregators for splitting nodes represented as a RDD of [[mymllib.local.model.tree.DecisionTreeStatsAgg]]
 ...
 *
    ...
    * @param input Input data represented as RDD of [[mymllib.common.obj.LabeledPoint]].
...
class DecisionTreeModel(val root: DecisionTreeNode,
  ...
  /**
    ...
    *
    * @param input Prediction data set which represented as a RDD of [[mymllib.common.obj.LabeledPoint]].
...
/**
  * Static functions of [[mymllib.local.model.tree.DecisionTreeTrainer]].
  */
...
private[tree] object DecisionTreePoint {
  ...
  /**
    * Convert input to a RDD of [[mymllib.local.model.tree.DecisionTreePoint]].
 *
    * @param input        A RDD of [[mymllib.common.obj.LabeledPoint]].
    * @param bins         Bins of all features.
    * @param num_bins_all Number of bins of all features.
    * @param num_fs       Number of features.
    * @param row_rate     sample rate of training data set.
    * @return A RDD of [[mymllib.local.model.tree.DecisionTreePoint]].
    */
  ...
  /**
    * Convert a data point into [[mymllib.local.model.tree.DecisionTreePoint]].
 *
    * @param lp           A [[mymllib.common.obj.LabeledPoint]] instance.
    * @param bins         Bins of all features.
    * @param num_bins_all Number of bins of all features.
    * @param num_fs       Number of fetures.
    * @param poisson      poisson distribution to sample without replacement.
    * @return A [[mymllib.local.model.tree.DecisionTreePoint]] instance.
    */
...
private[tree] object DecisionTreeNode {
  ...
  /**
    ...
    * @return A [[mymllib.local.model.tree.DecisionTreeNode]] instance.
    */
