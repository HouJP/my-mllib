...
object GradientBoost {
  ...
  /**
    ...
    * @return a [[mymllib.local.model.tree.GradientBoostModel]] instance.
    */
...
private[tree] class GradientBoostTrainer(impurity: Impurity,
  ...
  /**
    ...
    * @param train_data Training data points.
    * @param valid_data Validation data points.
    * @return a [[mymllib.local.model.tree.GradientBoostModel]] instance which can be used to predict.
    */
   ...
   *
   * @param data   A Sequence of [[mymllib.common.obj.LabeledPoint]] stored true label and features.
