...
//import bda.common.util.Poisson
...
/**
 * External interface of decision tree on spark.
 */
object DecisionTree {
...
private[tree] class DecisionTreeTrainer(impurity: Impurity,
   ...
   */
  def findSplits(sampled_features: Array[Double],
                 num_bins_all: Array[Int],
                 index_f: Int): Array[Double] = {
   ...
   * @return Array of [[bda.spark.model.tree.DecisionTreeNode]].
   */
   ...
   *
   * @param agg_leaves Aggregators for splitting nodes represented as a RDD of [[bda.spark.model.tree.DecisionTreeStatsAgg]]
...
private[tree] object DecisionTreeTrainer {
   ...
   */
  def numSplits(index_feature: Int, num_bins: Array[Int]): Int = {
...
object DecisionTreeModel {
   ...
   *
   * @param sc Spark context.
   * @param pt The directory of the decision tree model.
   * @return A [[bda.spark.model.tree.DecisionTreeModel]] instance.
   */
  def load(sc: SparkContext, pt: String): DecisionTreeModel = {

    sc.objectFile[DecisionTreeModel](pt).first()
  }
}
...
private[tree] object DecisionTreeNode {
   ...
   * @return A [[bda.spark.model.tree.DecisionTreeNode]] instance.
   */
